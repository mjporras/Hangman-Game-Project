...
def display_alphabet(alphabet_list):
    rows = []
    per_row = 30
...
def display_hint(secret_word, revealed_positions):
    hint = []
...
def get_single_letter_guess(alphabet_list):
    while True:
...
def pick_word(category, difficulty):
